...
@Database(
    entities = [Workout::class, Exercise::class, BodyProgress::class, Template::class, RewardEntity::class, RewardUnlockEventEntity::class, ExerciseTechniqueVideoCacheEntity::class],
    version = 15,
    exportSchema = false
)
