...
sealed class BodyPart(
    ...
    object UpperArms : BodyPart(R.drawable.ic_body_upper_arms, "biceps","biceps", "бицепс", "біцэпс")
    object Shoulders : BodyPart(R.drawable.ic_body_shoulders, "shoulders","shoulders", "плечи", "плячы")
    object LowerArms : BodyPart(R.drawable.ic_body_lower_arms, "triceps","triceps", "трицепс", "трыцэпс")
