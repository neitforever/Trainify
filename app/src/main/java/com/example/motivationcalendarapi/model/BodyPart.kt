...
sealed class BodyPart(
    ...
    object Waist : BodyPart(R.drawable.ic_body_torso, "waist", "waist", "талия", "талія")
    ...
    object Abductors : BodyPart(R.drawable.ic_body_abductors, "abductors", "abductors", "отводящие мышцы бедра", "адводзячыя мышцы сцягна")
    object Abs : BodyPart(R.drawable.ic_body_waist, "abs", "abs", "пресс", "прэс")
    object Adductors : BodyPart(R.drawable.ic_body_adductors, "adductors", "adductors", "приводящие мышцы бедра", "прыводзячыя мышцы сцягна")
    ...
    object Glutes : BodyPart(R.drawable.ic_body_glutes, "glutes", "glutes", "ягодицы", "ягадзіцы")
    object Hamstrings : BodyPart(R.drawable.ic_body_hamstrings, "hamstrings", "hamstrings", "бицепс бедра", "біцэпс сцягна")
    ...
    object Spine : BodyPart(R.drawable.ic_body_spine, "spine", "spine", "разгибатели позвоночника", "разгінальнікі пазваночніка")
    object Traps : BodyPart(R.drawable.ic_body_trapezius, "traps", "traps", "трапеции", "трапецыі")
