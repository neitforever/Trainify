...
class MainRepository(private val context: Context) {
    ...
    val minCardioTimeFlow: Flow<Float> = settingsDataStore.minCardioTimeFlow
    val maxCardioTimeFlow: Flow<Float> = settingsDataStore.maxCardioTimeFlow
    val stepCardioTimeFlow: Flow<Float> = settingsDataStore.stepCardioTimeFlow

    val minResistanceFlow: Flow<Float> = settingsDataStore.minResistanceFlow
    val maxResistanceFlow: Flow<Float> = settingsDataStore.maxResistanceFlow
    val stepResistanceFlow: Flow<Float> = settingsDataStore.stepResistanceFlow

    val minInclineFlow: Flow<Float> = settingsDataStore.minInclineFlow
    val maxInclineFlow: Flow<Float> = settingsDataStore.maxInclineFlow
    val stepInclineFlow: Flow<Float> = settingsDataStore.stepInclineFlow

    suspend fun saveCardioTimeSettings(min: Float, max: Float, step: Float) {
        settingsDataStore.saveCardioTimeSettings(min, max, step)
    }

    suspend fun saveResistanceSettings(min: Float, max: Float, step: Float) {
        settingsDataStore.saveResistanceSettings(min, max, step)
    }

    suspend fun saveInclineSettings(min: Float, max: Float, step: Float) {
        settingsDataStore.saveInclineSettings(min, max, step)
    }
